...
export const DaysSinceLastAppCard = () => {
  ...
  return (
    <div>
      <Card className="h-full">
        <CardHeader>
          <CardTitle>Last Application</CardTitle>
          <CardDescription>Days since last application</CardDescription>
          {/* <CardAction>
        ...
        <CardContent>
          <p className="text-3xl font-bold tabular-nums">29 days</p>
        </CardContent>
      </Card>
    </div>
  );
